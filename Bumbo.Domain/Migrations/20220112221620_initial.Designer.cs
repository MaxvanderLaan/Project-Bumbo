...
namespace Bumbo.Domain.Migrations
{
    ...
    [Migration("20220112221620_initial")]
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Availability", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            ApprovalStatus = 0,
                            EmployeeId = 1,
                            End = new DateTime(2021, 12, 9, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2021, 11, 9, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = 1
                        },
                        new
                        {
                            ...
                            ApprovalStatus = 2,
                            EmployeeId = 1,
                            End = new DateTime(2021, 12, 10, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            Start = new DateTime(2021, 11, 7, 7, 0, 0, 0, DateTimeKind.Unspecified),
                            Type = 1
                        });
                });
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Branch", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            BranchId = 1,
                            City = "BANANA",
                            Country = "BananaCountry",
                            Email = "JumboBanana@banana.nl",
                            HouseNumber = "52B",
                            Name = "Jumbo Banana",
                            PhoneNumber = "089398732",
                            ShelvesLength = 10,
                            State = "Bananana",
                            StreetName = "BAnananStreet",
                            ZipCode = "6473HD"
                        },
                        new
                        {
                            ...
                            City = "Den Bosch",
                            Country = "Nederland",
                            Email = "JumboDB@bumbo.nl",
                            HouseNumber = "2A",
                            Name = "Bumbo Den Bosch",
                            PhoneNumber = "0693128732",
                            ShelvesLength = 20,
                            State = "Noord-Brabant",
                            StreetName = "Bumbo Boulevard",
                            ZipCode = "6173HD"
                        },
                        new
                        {
                            ...
                            City = "Veghel",
                            Country = "Nederland",
                            Email = "JumboVeghel@bumbo.nl",
                            HouseNumber = "104",
                            Name = "Bumbo Veghel",
                            PhoneNumber = "0693121732",
                            ShelvesLength = 150,
                            State = "Noord-Brabant",
                            StreetName = "Veghel Industrieterrein",
                            ZipCode = "9054BZ"
                        });
                });
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Contract", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            MinimalHours = 4,
                            Scale = 1,
                            StartDate = new DateTime(2021, 6, 9, 0, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ContractId = 2,
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Forecast", b =>
                {
                    ...
                    b.HasData(
                        ...
                        new
                        {
                            ...
                            Description = "Nou ga maar lekker in je eentje werken, want het wordt kapot rustig",
                            RollContainers = 11
                        });
                });
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Registration", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            EmployeeId = 1,
                            EndDate = new DateTime(2021, 11, 9, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            StartDate = new DateTime(2021, 11, 9, 12, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            RegistrationId = 2,
                            CorrectClocking = true,
                            EmployeeId = 1,
                            EndDate = new DateTime(2021, 11, 9, 12, 0, 0, 0, DateTimeKind.Unspecified),
                            StartDate = new DateTime(2021, 11, 9, 7, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            RegistrationId = 3,
                            ...
                            EmployeeId = 1,
                            EndDate = new DateTime(2021, 11, 10, 2, 0, 0, 0, DateTimeKind.Unspecified),
                            StartDate = new DateTime(2021, 11, 9, 17, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
            ...
            modelBuilder.Entity("Bumbo.Domain.Models.Schedule", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            DepartmentId = 3,
                            EmployeeId = 1,
                            EndDate = new DateTime(2021, 11, 8, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            Finalised = true,
                            StartDate = new DateTime(2021, 11, 8, 9, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ScheduleId = 2,
                            ...
                            EndDate = new DateTime(2021, 11, 9, 17, 0, 0, 0, DateTimeKind.Unspecified),
                            Finalised = false,
                            StartDate = new DateTime(2021, 11, 9, 9, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ScheduleId = 3,
                            DepartmentId = 3,
                            EmployeeId = 2,
                            EndDate = new DateTime(2021, 11, 8, 17, 30, 0, 0, DateTimeKind.Unspecified),
                            Finalised = true,
                            StartDate = new DateTime(2021, 11, 8, 12, 0, 0, 0, DateTimeKind.Unspecified)
                        },
                        new
                        {
                            ScheduleId = 4,
                            DepartmentId = 2,
                            EmployeeId = 2,
                            EndDate = new DateTime(2021, 11, 9, 17, 30, 0, 0, DateTimeKind.Unspecified),
                            Finalised = false,
                            StartDate = new DateTime(2021, 11, 9, 12, 0, 0, 0, DateTimeKind.Unspecified)
                        });
                });
